...
<body class="admin-body">
    ...
    <main class="admin-main">
        ...
        <form method="post" action="${pageContext.request.contextPath}/admin/blog-form" class="blog-editor">
            ...
            <label>
                Tiêu đề
                <input name="title" maxlength="200" required value="<c:out value='${blog.title}'/>">
            </label>
            <label>
                Slug
                <input name="slug" maxlength="200" placeholder="Để trống để tự tạo từ tiêu đề" value="<c:out value='${blog.slug}'/>">
                <small>Ví dụ: kinh-nghiem-du-lich-ha-noi</small>
            </label>
            <label>
                URL ảnh đại diện
                <input type="url" name="thumbnailUrl" maxlength="500" value="<c:out value='${blog.thumbnailUrl}'/>">
            </label>
            <label>
                Nội dung
                <textarea name="content" rows="20" required placeholder="Nội dung bài viết..."><c:out value="${blog.content}"/></textarea>
            </label>
