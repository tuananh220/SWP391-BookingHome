...
<main class="host-wrap">
    <div class="host-page-head">
        <div><p class="eyebrow">FACILITIES</p><h1>Quản lý tiện ích</h1></div>
    ...
    <c:choose>
        <c:when test="${empty amenities}"><section class="empty-state"><h3>Chưa có tiện ích</h3></section></c:when>
        <c:otherwise>
            <div class="host-table-wrap">
                <table class="host-table">
                    <thead><tr><th>ID</th><th>Tên tiện ích</th><th>Icon</th><th></th></tr></thead>
                    <tbody>
