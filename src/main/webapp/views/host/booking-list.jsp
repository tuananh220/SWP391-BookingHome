    ...
    <body class="host-body">
        ...
        <main class="host-wrap">
            ...
            <nav class="status-tabs">
                ...
                <a class="${selectedStatus == 'Pending' ? 'active' : ''}" href="${pageContext.request.contextPath}/host/bookings?status=Pending">Chờ xử lý</a>
                <a class="${selectedStatus == 'Confirmed' ? 'active' : ''}" href="${pageContext.request.contextPath}/host/bookings?status=Confirmed">Đã xác nhận</a>
                <a class="${selectedStatus == 'Completed' ? 'active' : ''}" href="${pageContext.request.contextPath}/host/bookings?status=Completed">Hoàn thành</a>
                <a class="${selectedStatus == 'Rejected' ? 'active' : ''}" href="${pageContext.request.contextPath}/host/bookings?status=Rejected">Từ chối</a>
                <a class="${selectedStatus == 'Cancelled' ? 'active' : ''}" href="${pageContext.request.contextPath}/host/bookings?status=Cancelled">Đã hủy</a>
            </nav>
                                ...
                                <c:forEach items="${bookings}" var="booking">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small>
                                                <c:out value="${booking.customerPhone}"/>
                                            </small>
                                        </td>
                                        <td>
                                            <strong>${booking.checkInDate}</strong>
                                            <small>đến ${booking.checkOutDate} · ${booking.totalGuests} khách</small>
                                        </td>
                                        <td>
                                            <strong>
                                                <c:out value="${booking.paymentMethodName}"/>
                                            </strong>
                                            <small>
                                        ...
                                        <td>
                                            <a class="table-action" href="${pageContext.request.contextPath}/host/booking-detail?id=${booking.bookingId}">Chi tiết</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
