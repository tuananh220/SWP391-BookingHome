 ...
 * @author Admin
 */
@WebServlet(name = "HostBookingDetailController", urlPatterns = {"/host/booking-detail"})
public class HostBookingDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HostBookingDetailController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HostBookingDetailController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean canCancel = "Pending".equals(booking.getBookingStatus())
                || "Confirmed".equals(booking.getBookingStatus());
        request.setAttribute("canCancel", canCancel);
        request.setAttribute(
                "estimatedRefund", service.estimateRefund(booking)
        );
        request.getRequestDispatcher("/views/host/booking-detail.jsp")
