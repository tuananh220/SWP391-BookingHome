    ...
    <main class="auth-shell">
        ...
        <section class="form-panel">
            <form method="post" action="${pageContext.request.contextPath}/register" class="auth-card">
                ...
                <label>
                    Họ và tên
                    <input type="text" name="fullName" maxlength="100" required autocomplete="name" value="<c:out value='${requestScope.fullName}'/>">
                </label>
                <label>
                    Email
                ...
                <label>
                    Số điện thoại
                    <input type="tel" name="phoneNumber" maxlength="20" autocomplete="tel" value="<c:out value='${requestScope.phoneNumber}'/>">
                </label>
                <fieldset class="role-choice">
                    <legend>Bạn muốn đăng ký với vai trò</legend>
                    <label class="role-card">
                        <input type="radio" name="roleName" value="Customer" ${empty requestScope.roleName || requestScope.roleName == 'Customer' ? 'checked' : ''}>
                        <span><strong>Khách hàng</strong> Đặt phòng, lưu homestay yêu thích và viết bài. </span>
                    </label>
                    <label class="role-card">
                        <input type="radio" name="roleName" value="Home Owner" ${requestScope.roleName == 'Home Owner' ? 'checked' : ''}>
                        <span><strong>Chủ nhà</strong> Đăng homestay, nhận booking và quản lý lịch. </span>
                    </label>
                </fieldset>
                <div class="field-grid">
                    ...
                    <label>
                        Xác nhận mật khẩu
                        <input type="password" name="confirmPassword" minlength="6" required autocomplete="new-password">
                    </label>
                </div>
                <button type="submit">Tạo tài khoản</button>
                <p class="switch-link">Đã có tài khoản? <a href="${pageContext.request.contextPath}/login">Đăng nhập</a></p>
            </form>
        </section>
    </main>
</body>
