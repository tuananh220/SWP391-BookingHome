        ...
        <main class="host-wrap">
            ...
            <c:choose>
                <c:when test="${empty bookings}">
                    <section class="empty-state"><h3>Không có booking phù hợp</h3><p>Các yêu cầu mới sẽ xuất hiện tại đây.</p></section>
                    </c:when>
                    <c:otherwise>
                    <div class="host-table-wrap">
                        <table class="host-table">
                            <thead><tr><th>Booking</th><th>Khách hàng</th><th>Lưu trú</th><th>Thanh toán</th><th>Tổng tiền</th><th>Trạng thái</th><th></th></tr></thead>
                            <tbody>
