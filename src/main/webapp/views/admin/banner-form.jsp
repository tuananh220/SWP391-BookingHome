...
<body class="admin-body">
    ...
    <main class="admin-main">
        ...
        <form method="post" action="${pageContext.request.contextPath}/admin/banner-form" class="admin-editor">
            ...
            <label>
                Tiêu đề
                <input name="title" maxlength="100" value="<c:out value='${banner.title}'/>">
            </label>
            <label>
                URL hình ảnh
                <input type="url" name="imageUrl" maxlength="500" required value="<c:out value='${banner.imageUrl}'/>">
            </label>
            <label>
                URL đích
                <input name="targetUrl" maxlength="500" placeholder="/homestays?city=Ha Noi hoặc https://..." value="<c:out value='${banner.targetUrl}'/>">
            </label>
            <label>
                Thứ tự hiển thị
                <input type="number" name="displayOrder" min="0" required value="${banner.displayOrder}">
            </label>
