    ...
    <main class="admin-main">
        ...
        <section class="admin-metrics">
            <article class="accent">
                <span>Doanh thu</span>
                <strong><fmt:formatNumber value="${summary.totalRevenue}" pattern="#,##0"/> ₫</strong>
            </article>
            <article>
        ...
        <section class="admin-shortcuts">
            ...
            <div>
                <a href="${pageContext.request.contextPath}/admin/users"><b>Quản lý tài khoản</b><span>Xem, chỉnh sửa và khóa người dùng →</span></a>
                <a href="${pageContext.request.contextPath}/admin/homestays"><b>Duyệt homestay</b><span>Xử lý các homestay đang Pending →</span></a>
                <a href="${pageContext.request.contextPath}/admin/reviews"><b>Quản lý đánh giá</b><span>Ẩn hoặc xử lý báo cáo review →</span></a>
            </div>
        </section>
    </main>
</body>
