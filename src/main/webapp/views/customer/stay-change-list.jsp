                    ...
                    <c:forEach items="${requests}" var="item">
                        <article class="change-request-card">
                            ...
                            <div class="change-request-data">
                                <span><b>Loại</b> ${item.requestType == 'Extension' ? 'Gia hạn' : 'Trả phòng sớm'} </span>
                                <span><b>Ngày cũ</b> ${item.originalCheckOutDate} </span>
                                <span><b>Ngày yêu cầu</b> ${item.requestedCheckOutDate} </span>
                                <span>
                            ...
                            <c:if test="${not empty item.responseNote}">
                                <p class="response-note"><strong>Phản hồi:</strong><c:out value="${item.responseNote}"/></p>
                            </c:if>
