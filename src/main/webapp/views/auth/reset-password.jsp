            ...
            <form method="post" action="${pageContext.request.contextPath}/reset-password" class="auth-card">
                ...
                <c:if test="${not empty requestScope.otp}">
                    <div class="alert success">
                        Mã OTP của bạn:
                        <strong><c:out value="${requestScope.otp}"/></strong>
                        (demo, dùng để nhập bên dưới)
                    </div>
                </c:if>
                ...
                <label>
                    Mã OTP
                    <input type="text" name="otp" maxlength="6" required value="<c:out value='${requestScope.otp}'/>">
                </label>
                ...
                <p class="switch-link"><a href="${pageContext.request.contextPath}/forgot-password">Gửi lại OTP</a></p>
            </form>
        </section>
    </main>
</body>
