                    ...
                    <c:forEach items="${vouchers}" var="voucher">
                        <article class="voucher-card ${voucher.active ? '' : 'inactive'}">
                            <div class="voucher-cut">
                                ...
                                <strong><fmt:formatNumber value="${voucher.discountRate}" maxFractionDigits="0"/> % </strong>
                            ...
                            <div class="voucher-content">
                                ...
                                <p>
                                    Giảm tối đa:
                                    <c:choose>
                                        <c:when test="${empty voucher.maxDiscountAmount}">
                                            Không giới hạn
                                        </c:when>
                                        <c:otherwise>
                                ...
                                <div class="voucher-usage">
                                    ...
                                    <progress value="${voucher.usedCount}" max="${voucher.usageLimit}"></progress>
                                </div>
