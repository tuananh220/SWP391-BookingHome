        ...
        <div class="booking-detail-grid">
                ...
                <section class="detail-panel">
                    ...
                    <div class="detail-data-grid">
                        <div>
                            ...
                            <strong><c:out value="${empty booking.paymentMethodName ? 'Không phát sinh' : booking.paymentMethodName}"/></strong>
                        </div>
                        <div>
                            <span>Trạng thái</span>
                            <strong><c:out value="${empty booking.paymentStatus ? 'Không phát sinh' : booking.paymentStatus}"/></strong>
                        </div>
                    </div>
            ...
            <aside class="detail-price-panel">
                ...
                <div>
                    ...
                    <span><fmt:formatNumber value="${booking.originalAmount}" pattern="#,##0"/> ₫</span>
                </div>
                <div class="discount">
                    <span>Giảm giá</span>
