...
<body>
    ...
    <main class="review-form-wrap">
        ...
        <form method="post" action="${pageContext.request.contextPath}/customer/review/create" enctype="multipart/form-data" class="review-form">
            ...
            <fieldset class="rating-field">
                ...
                <div class="star-options">
                    <c:forEach begin="1" end="5" var="star">
                        <label>
                            <input type="radio" name="ratingStars" value="${star}" required ${selectedRating == star ? 'checked' : ''}>
                            <span>${star} ★</span>
                        </label>
                    </c:forEach>
                </div>
            ...
            <label class="review-label upload-box">
                Ảnh trải nghiệm
