...
<header class="host-header">
    <a class="brand light" href="${pageContext.request.contextPath}/host/dashboard">HOST CENTER</a>
    <nav>
        ...
        <a href="${pageContext.request.contextPath}/host/stay-change-requests">Gia hạn</a>
